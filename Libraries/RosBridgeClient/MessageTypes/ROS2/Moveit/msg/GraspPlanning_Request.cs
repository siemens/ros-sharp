...
{
    public class GraspPlanning_Request : Message
    {
        public const string RosMessageName = "moveit_msgs/msg/GraspPlanning_Request";
        ...
        public GraspPlanning_Request(string group_name, CollisionObject target, string[] support_surfaces, Grasp[] candidate_grasps, CollisionObject[] movable_obstacles)
        {
