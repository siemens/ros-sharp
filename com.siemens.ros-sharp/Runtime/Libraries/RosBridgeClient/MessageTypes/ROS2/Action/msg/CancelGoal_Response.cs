...
{
    public class CancelGoal_Response : Message
    {
        public const string RosMessageName = "action_msgs/msg/CancelGoal_Response";
        ...
        public CancelGoal_Response(sbyte return_code, GoalInfo[] goals_canceling)
        {
