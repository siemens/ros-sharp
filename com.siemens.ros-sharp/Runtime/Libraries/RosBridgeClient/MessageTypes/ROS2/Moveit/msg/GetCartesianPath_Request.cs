...
{
    public class GetCartesianPath_Request : Message
    {
        public const string RosMessageName = "moveit_msgs/msg/GetCartesianPath_Request";
        ...
        public GetCartesianPath_Request()
        {
        ...
        public GetCartesianPath_Request(Header header, RobotState start_state, string group_name, string link_name, Pose[] waypoints, double max_step, double jump_threshold, double prismatic_jump_threshold, double revolute_jump_threshold, bool avoid_collisions, Constraints path_constraints)
        {
            this.header = header;
