...
{
    public class GetPositionFK_Request : Message
    {
        public const string RosMessageName = "moveit_msgs/msg/GetPositionFK_Request";
        ...
        public GetPositionFK_Request(Header header, string[] fk_link_names, RobotState robot_state)
        {
            this.header = header;
