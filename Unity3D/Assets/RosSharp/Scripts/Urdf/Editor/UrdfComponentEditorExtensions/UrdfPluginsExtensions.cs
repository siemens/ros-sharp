...
{
    public static class UrdfPluginsExtensions
    {
        public static void Create(Transform robot, List<Plugin> plugins = null)
        {
            ...
            foreach (var plugin in plugins)
                UrdfPluginExtensions.Create(pluginsObject.transform, plugin);
        }

        public static List<Plugin> ExportPluginsData(this UrdfPlugins urdfPlugins)
        {
            return urdfPlugins.GetComponents<UrdfPlugin>()
