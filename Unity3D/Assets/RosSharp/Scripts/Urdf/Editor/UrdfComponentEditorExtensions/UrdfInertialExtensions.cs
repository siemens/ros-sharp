...
{
    public static class UrdfInertialExtensions
    {
        ...
        private static void ImportInertiaData(this UrdfInertial urdfInertial, Link.Inertial.Inertia inertia)
        {
            Vector3 eigenvalues;
        ...
        #region Export
        public static Link.Inertial ExportInertialData(this UrdfInertial urdfInertial)
        {
            Rigidbody _rigidbody = urdfInertial.GetComponent<Rigidbody>();
